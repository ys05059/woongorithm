...
//    println(triangleList.joinToString(","))
...
//    println("unit $unit")
//    println(pyramidUnit.joinToString(","))
    var dp = IntArray(n+1)
...
//    var i = k-1
//    while(remain > 0 && i >0 ){
//        println("pyramidUnit[$i] = ${pyramidUnit[i]}")
//        val mok = remain / pyramidUnit[i]
//        println("mok : $mok")
//        remain -= (pyramidUnit[i--] * mok)
//        answer += mok
//    }